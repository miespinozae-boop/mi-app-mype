...
# -----------------------------------------------------------------------------
# CUSTOM CSS FOR EXACT UI REPLICATION
# -----------------------------------------------------------------------------
st.markdown("""
<style>
    /* Google Font Import */
...
with chart_col_left:
    ...
    # Generate mock 30-day timeline data matching exact curve
    days = [f"{i} Abr" for i in [1, 5, 10, 15, 20, 25, 30]]
    ...
    fig_line.add_trace(go.Scatter(
        ...
        marker=dict(size=6, color='#2563EB', stroke=dict(color='#FFFFFF', width=2)),
        fill='tozeroy',
...
# -----------------------------------------------------------------------------
# BOTTOM ROW (ROW 3) - 3 EQUAL COLUMNS
# -----------------------------------------------------------------------------
    ...
    st.markdown("""
        <div class="content-card">
            ...
            <div class="product-row">
                <div class="product-info"><span>1. Arroz</span><span>320 un.</span></div>
                <div class="progress-bg"><div class="progress-fill" style="width: 100%; background-color: #2563EB;"></div></div>
            </div>
            <div class="product-row">
                <div class="product-info"><span>2. Aceite</span><span>280 un.</span></div>
                <div class="progress-bg"><div class="progress-fill" style="width: 87.5%; background-color: #10B981;"></div></div>
            </div>
            <div class="product-row">
                <div class="product-info"><span>3. Leche</span><span>220 un.</span></div>
                <div class="progress-bg"><div class="progress-fill" style="width: 68.7%; background-color: #8B5CF6;"></div></div>
            </div>
            <div class="product-row">
                <div class="product-info"><span>4. Galletas</span><span>180 un.</span></div>
                <div class="progress-bg"><div class="progress-fill" style="width: 56.2%; background-color: #F97316;"></div></div>
            </div>
            <div class="product-row">
                <div class="product-info"><span>5. Detergente</span><span>160 un.</span></div>
                <div class="progress-bg"><div class="progress-fill" style="width: 50%; background-color: #06B6D4;"></div></div>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
with bot_col2:
    ...
    fig_pie_channel = go.Figure(data=[go.Pie(
